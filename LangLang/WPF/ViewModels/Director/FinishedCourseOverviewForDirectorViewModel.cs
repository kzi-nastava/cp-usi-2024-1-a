...
public class FinishedCourseOverviewForDirectorViewModel : ViewModelBase
{
    ...
    public FinishedCourseOverviewForDirectorViewModel(ICourseService courseService, ITimetableService timetableService, IPopupNavigationService popupNavigationService, CurrentCourseStore currentCourseStore, ITutorService tutorService, ILanguageService languageService)
    {
